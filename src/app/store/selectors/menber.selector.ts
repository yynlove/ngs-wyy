...
export const getModal= createFeatureSelector<MemberState>('member');
...
export const getShareInfo = createSelector(selectMemberStates,(state:MemberState) => state.info);